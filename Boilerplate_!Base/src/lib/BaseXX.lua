...
X.DecodeBit = basexx.from_bit
X.EncodeBit = basexx.to_bit
X.DecodeHex = basexx.from_hex
X.EncodeHex = basexx.to_hex
X.DecodeBase32 = basexx.from_base32
X.EncodeBase32 = basexx.to_base32
X.DecodeCrockford = basexx.from_crockford
